    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>&nbsp;&nbsp;&nbsp;<?= $this->lang->line('magnet_related_search'); ?></h3>
            </div>
                    ...
                    <div class="x_content">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-4 col-sm-12 col-xs-12" style="margin-top: 110px;">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <center>
                                        <button type="button" data-toggle="modal" data-target="#modal_magnet_history" class="btn btn-primary"><?= $this->lang->line('history'); ?></button>
                                    </center>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px; padding-top: 20px; padding-bottom: 20px; border-top: 2px solid #46b8da;">
                            <form class="form-horizontal form-label-left" id="magnet_form" action="javascript:;" novalidate>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="item form-group">
                                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 50px;">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <label class="control-label"><?= $this->lang->line('keyword'); ?></label>
                                                </div>
                                                <input type="text" id="magnet_keyword" class="input-category" required="required" >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="item form-group">
                                            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 50px;">
                                                ...
                                                <select class="form-control input-box" required="required" id="magnet_market_place">
                                                    <option value=""></option>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin: 30px;">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-6">
                                        <center>
                                            <button type="submit" id="btn_check_key" class="btn btn-round btn-primary"><?= $this->lang->line('get_keywords'); ?></button>
                                        </center>
                                    </div>
                                </div>
                            </form>
...
<!--begin::Modal History-->
<div class="modal fade" id="modal_magnet_history" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" style="width: 650px;">
            <div class="modal-header">
                <h4 class="modal-title col-md-10 col-sm-10 col-xs-10" id="exampleModalLabel"><?= $this->lang->line('magnet_related_search'); ?> <?= $this->lang->line('history'); ?></h4>
            ...
            <div class="modal-body">
                <div class="col-md-12 col-sm-12 col-xs-12" style="border-bottom: 1px solid #e5e5e5; padding: 20px; margin-bottom: 20px;">
                    <table id="table_magnet_history" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
