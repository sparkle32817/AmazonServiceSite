<style>
	...
	#table_bigdata_key_checker_history{
                ...
                <div class="x_panel" style="min-height: 1000px;">
					...
					<div class="x_content">
						...
						<div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px; padding-top: 20px; padding-bottom: 20px; border-top: 2px solid #46b8da;">
							<form class="form-horizontal form-label-left" id="key_checker_form" action="javascript:;" novalidate>
...
<!--begin::Modal History-->
<div class="modal fade" id="modal_key_checker_history" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
