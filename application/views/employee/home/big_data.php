    ...
    <div class="row">
        <div class="col-md-5 col-sm-5 col-xs-12">
            <div class="x_panel" style="min-height: 320px;">
                ...
                <div class="x_content">
                    <table id="table_pending" class="table table-striped table-bordered dt-responsive nowrap"
        ...
        <div class="col-md-7 col-sm-7 col-xs-12">
            <div class="x_panel" style="min-height: 340px;">
                ...
                <div class="x_content">
                    <table id="table_complete" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead  style="background-color: #000000; color: #dedee0">
                            <th>Ticket ID</th>
                            <th>Client Name</th>
                            <th>Service Name</th>
            ...
            <div class="x_panel" style="min-height: 500px;">
                ...
                <div class="x_content" id="task_stauts" style="display: none;">
						...
						<form id="form_task_completion" action="javascript:;">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
								<div class="col-md-6 col-sm-6 col-xs-12">
									<a href="javascript:;" id="file_export_task_data" class="btn btn-round btn-default" style="float:right; width: 70px; margin-right: 50px; cursor: pointer;" title="Download Task Data">
							...
							<div class="col-md-6 col-sm-6 col-xs-6">
                                <div class="col-md-2 col-sm-3"><button id="btn_finish" type="submit" class="btn btn-round btn-primary">Completion</button></div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 20px;">
                        <center><button id="btn_start_working" type="button" class="btn btn-round btn-primary">Start Working</button></center>
                    </div>
                </div>
            </div>
        </div>
