...
class SearchTermOptimization extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $service_arr = array('Big Data-optimization', 'Big Data-Advertising', 'Big Data-Product', 'Big Data-Keyword');
        ...
        $this->load->view('employee/home/key_optimization');
    ...
    public function getTaskDetailInfo()
    {
        ...
        if ($result['status']=='complete'){
            ...
            $returnVal['content_completion'] = $this->getContentCompletionFromKeyOptimization($task_id);
        }
        else
        {
    ...
    public function getPendingTableInfo()
    {
        ...
        $service_arr = array('Search Term Optimization');
    ...
    public function completeTask()
    {
        ...
        $returnVal = 'fail';
        if ($this->Optimization_model->completeTask($_POST))
        {
            $returnVal = $this->Employee_task->completeTask($this->session->userdata['employee_logged_in'], $_POST['task_id']);
        }
    ...
    public function getContentNormalFromKeyOptimization($task_id)
    {
        ...
        $str_content = '<div class="col-md-12 col-sm-12 col-xs-12" style="padding-bottom: 10px;">
							<div class="col-md-4 col-sm-4 col-xs-12">
								...
								<div class="item form-group">
									<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 50px;">
										...
										<div class="col-md-10 col-sm-10 col-xs-12" style="padding: 0px;">
											<input type="text" class="input-optimization" value="'.$result['asin'].'" readonly>
										</div>
									</div>
								</div>
							</div>
    ...
    public function getContentCompletionFromKeyOptimization($task_id)
    {
        $result = $this->Optimization_model->getSearchedData((int)str_replace('Ticket', '', $task_id));
        ...
        $str_content = '<div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px;">
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <div class="item form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 40px;">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="input-optimization col-md-7 col-xs-12" value="'.$result['search_term'].'" readonly>
                                    </div>
                                </div>
                                <div class="item form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px;">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="input-optimization col-md-7 col-xs-12" value="'.$result['subject1'].'" readonly>
                                    </div>
                                </div>
                                <div class="item form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="input-optimization col-md-7 col-xs-12" value="'.$result['subject2'].'" readonly>
                                    </div>
                                </div>
                                <div class="item form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                                    <div class="col-md-4 col-sm-4 col-xs-12" style="margin-top: 5px;">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="input-optimization col-md-7 col-xs-12" value="'.$result['subject3'].'" readonly>
                                    </div>
                                </div>
                                <div class="item form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                                    <div class="col-md-4 col-sm-4 col-xs-12" style="margin-top: 5px;">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="input-optimization col-md-7 col-xs-12" value="'.$result['subject4'].'" readonly>
                                    </div>
                                </div>
                                <div class="item form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                                    <div class="col-md-4 col-sm-4 col-xs-12" style="margin-top: 5px;">
                                    ...
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <input type="text" class="input-optimization col-md-7 col-xs-12" value="'.$result['subject5'].'" readonly>
                                    </div>
                                </div>
                            </div>
                            '.$str_textarea.'
    ...
    public function processServiceKeyOptimization($task_id, $file_name)
    {
        $asin_id = $this->Optimization_model->getRelatedTaskID($task_id);
...
//				return $header;
                while (($content = fgetcsv($file_data)) !== FALSE) {
                    ...
                    $this->Optimization_model->insertCompleteData($asin_id, $arr);
                }
    ...
    public function confirmCsvBigDataCategory($asin_id, $file_data)
    {
        ...
        $seller_id = $this->Optimization_model->getSellerID($asin_id);
        ...
        while (($content_arr = fgetcsv($file_data)) !== FALSE)
        {
            ...
            if (!$this->Optimization_model->checkKeyword($asin_id, $content_arr[0]))
