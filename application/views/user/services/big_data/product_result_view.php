    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>&nbsp;&nbsp;&nbsp;<?= $this->lang->line('big_data'); ?> – <?= $this->lang->line('product'); ?>(<?= $this->lang->line('result_view'); ?>)</h3>
            </div>
                ...
                <div class="x_panel" style="min-height: 500px;">
                    <div class="x_content">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 40px;">
                            ...
                            <table id="table_bigdata_product" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <th><?= $this->lang->line('t_prox_score'); ?></th>
