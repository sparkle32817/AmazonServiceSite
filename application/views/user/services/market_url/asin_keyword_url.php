                    ...
                    <div class="x_content">
                        <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 100px;">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10">
                                <label class="col-md-12 col-sm-12 col-xs-10 letter"> <?= $this->lang->line('benefits_text21'); ?></label>
                            </div>
                        </div>
                        <div class="form-group col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px;">
                            ...
                            <div class="col-md-10 col-sm-10 col-xs-10">
                                <label class="col-md-12 col-sm-12 col-xs-12 letter"> <?= $this->lang->line('uses_text21'); ?> </label>
                                <label class="col-md-12 col-sm-12 col-xs-12 letter"> <?= $this->lang->line('uses_text22'); ?> </label>
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-2"></div>
                        <div class="col-md-8 col-sm-8 col-xs-12" style="margin-top: 30px;">
                            <form class="form-horizontal form-label-left" id="asin_form" action="javascript:;" novalidate>
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px;">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select name="market_place" class="form-control input-box" required="required" id="asin_market_place">
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="asin_asin" required="required" placeholder="<?= $this->lang->line('asin'); ?>(*)" class="form-control col-md-7 col-xs-12 input-box">
                                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="item form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="asin_keywords" required="required" placeholder="<?= $this->lang->line('keyword'); ?>(*)" class="form-control col-md-7 col-xs-12 input-box">
                                            </div>
                                            <!--										<label class="control-label"> ( mandatory )</label>-->
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 30px;">
                                    ...
                                    <div class="col-md-8 col-sm-7 col-xs-12">
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="asin_url">
                                            <span class="input-group-btn">
											  <button type="button" class="btn btn-primary" id="asin_btn_copy" style="border-radius: 0px; margin-right: 0px;">
												  <i class="fa fa-copy" title="<?= $this->lang->line('copy_link'); ?>"></i>
											  </button>
											</span>
                                            <span class="input-group-btn">
											  <button type="button" class="btn btn-primary" id="asin_btn_go">
